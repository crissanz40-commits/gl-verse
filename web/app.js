const actresses = [
  { id: "freen", name: "Sarocha Chankimha", stageName: "Freen", initials: "FS", colors: ["#63325a", "#d76f9c"], imageUrl: null, imageSourceUrl: null },
  { id: "becky", name: "Rebecca Armstrong", stageName: "Becky", initials: "BA", colors: ["#7d3c55", "#e6a17f"], imageUrl: null, imageSourceUrl: null },
  { id: "namtan", name: "Tipnaree Weerawatnodom", stageName: "Namtan", initials: "NT", colors: ["#203b70", "#7761ae"], imageUrl: null, imageSourceUrl: null },
  { id: "film", name: "Rachanun Mahawan", stageName: "Film", initials: "FR", colors: ["#423b7e", "#a66ab1"], imageUrl: null, imageSourceUrl: null },
  { id: "milk", name: "Pansa Vosbein", stageName: "Milk", initials: "MP", colors: ["#a14b3e", "#e99568"], imageUrl: null, imageSourceUrl: null },
  { id: "love", name: "Pattranite Limpatiyakorn", stageName: "Love", initials: "LP", colors: ["#ca6a75", "#f1b88d"], imageUrl: null, imageSourceUrl: null },
  { id: "ciize", name: "Apichaya Saejung", stageName: "Ciize", initials: "CA", colors: ["#285a69", "#6eb6ad"], imageUrl: null, imageSourceUrl: null },
  { id: "lingling", name: "Sirila Kwong", stageName: "Lingling", initials: "LK", colors: ["#315a5b", "#81a88f"], imageUrl: null, imageSourceUrl: null },
  { id: "orm", name: "Kornnaphat Sethratanapong", stageName: "Orm", initials: "OK", colors: ["#4b6d5c", "#b2c991"], imageUrl: null, imageSourceUrl: null },
  { id: "lookmhee", name: "Punyapat Wangpongsathaporn", stageName: "Lookmhee", initials: "LP", colors: ["#693344", "#c96d78"], imageUrl: null, imageSourceUrl: null },
  { id: "sonya", name: "Saranphat Pedersen", stageName: "Sonya", initials: "SS", colors: ["#843e52", "#df8c89"], imageUrl: null, imageSourceUrl: null },
];
...
const series = [
  { id: "gap", title: "GAP: The Series", year: 2022, country: "Tailandia", ending: "happy", drama: 2, chemistry: 9.6, popularity: 100, provider: "YouTube", initials: "GM", colors: ["#62224f", "#da6296"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "Mon empieza a trabajar en la empresa de Sam, a quien admira desde joven. La distancia entre sus mundos se convierte poco a poco en una historia de amor.", cast: [{ actressId: "freen", character: "Sam", importance: "lead" }, { actressId: "becky", character: "Mon", importance: "lead" }] },
  { id: "loyal-pin", title: "The Loyal Pin", year: 2024, country: "Tailandia", ending: "happy", drama: 3, chemistry: 9.5, popularity: 94, provider: "YouTube", initials: "AP", colors: ["#774626", "#d7a75a"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "Una historia de época sobre dos jóvenes unidas desde la infancia que deben proteger un amor enfrentado a las expectativas de palacio.", cast: [{ actressId: "freen", character: "Anin", importance: "lead" }, { actressId: "becky", character: "Pin", importance: "lead" }] },
  { id: "pluto", title: "Pluto", year: 2024, country: "Tailandia", ending: "happy", drama: 4, chemistry: 9.4, popularity: 97, provider: "YouTube", initials: "AM", colors: ["#152950", "#7954a6"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "Una identidad prestada y un vínculo inesperado abren un misterio romántico donde cada verdad cambia lo que creemos saber de la pareja.", cast: [{ actressId: "namtan", character: "Ai-oon", importance: "lead" }, { actressId: "film", character: "May", importance: "lead" }] },
  { id: "23-5", title: "23.5", year: 2024, country: "Tailandia", ending: "happy", drama: 1, chemistry: 8.9, popularity: 88, provider: "Netflix", initials: "OS", colors: ["#db744f", "#f5b766"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "Ongsa, tímida y enamorada, conoce online a la popular Sun bajo un nombre que oculta quién es. Una comedia romántica luminosa y juvenil.", cast: [{ actressId: "milk", character: "Ongsa", importance: "lead" }, { actressId: "love", character: "Sun", importance: "lead" }, { actressId: "ciize", character: "Alpha", importance: "supporting" }] },
  { id: "secret-of-us", title: "The Secret of Us", year: 2024, country: "Tailandia", ending: "happy", drama: 4, chemistry: 9.3, popularity: 96, provider: "Ch3+", initials: "LE", colors: ["#315a5b", "#8bb596"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "Dos antiguas amantes vuelven a encontrarse cuando sus vidas profesionales se cruzan, obligándolas a mirar de frente una ruptura nunca resuelta.", cast: [{ actressId: "lingling", character: "Lada", importance: "lead" }, { actressId: "orm", character: "Earn", importance: "lead" }] },
  { id: "affair", title: "Affair", year: 2024, country: "Tailandia", ending: "happy", drama: 5, chemistry: 9.2, popularity: 90, provider: "iQIYI", initials: "WP", colors: ["#682936", "#bf6a6f"], coverImageUrl: null, coverImageSourceUrl: null, synopsis: "La amistad inseparable entre Wan y Pleng se transforma en algo más profundo mientras el tiempo, la familia y sus decisiones ponen a prueba el vínculo.", cast: [{ actressId: "lookmhee", character: "Wan", importance: "lead" }, { actressId: "sonya", character: "Pleng", importance: "lead" }] },
];
...
function mediaMarkup(item, kind, label, showSource = true) {
  ...
  const media = imageUrl ? `<img src="${imageUrl}" alt="${label}" />` : fallback;
